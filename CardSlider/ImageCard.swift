...
class ImageCard: CardView {
    ...
    override init(frame: CGRect) {
        ...
        imageView.backgroundColor = UIColor(red: 110/255, green: 30/255, blue: 225/255, alpha: 1.0)
        ...
        let textBox1 = UIView()
        textBox1.backgroundColor = UIColor(red: 110/255, green: 30/255, blue: 225/255, alpha: 1.0)
        ...
        let textBox2 = UIView()
        textBox2.backgroundColor = UIColor(red: 110/255, green: 30/255, blue: 225/255, alpha: 1.0)
