...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = UIColor(red: 110/255, green: 30/255, blue: 225/255, alpha: 1.0)
...
extension ViewController {
    ...
    func setUpDummyUI() {
        ...
        titleLabel.frame = CGRect(x: (self.view.frame.width / 2) - 200, y: 17, width: 180, height: 60)
        //self.view.addSubview(titleLabel)
        
        // REACT
        let reactLabel = UILabel()
        reactLabel.text = "CHOOSE!"
        reactLabel.font = UIFont(name: "AvenirNextCondensed-Heavy", size: 28)
        reactLabel.textColor = UIColor(red: 255, green: 255, blue: 255, alpha: 1.0)
        ...
        // ICO Alert Label
        let ICOAlert = UIImageView(image: UIImage(named: "ICOAlert"))
        ICOAlert.contentMode = .scaleAspectFit
        ICOAlert.frame = CGRect(x: (self.view.frame.width / 2) - 185, y: -90, width: 375, height: 275)
        ICOAlert.isUserInteractionEnabled = false
        self.view.addSubview(ICOAlert)
    }
}
